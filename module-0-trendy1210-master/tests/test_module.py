...
def test_module(size_a, size_b):
    ...
    nam_parameters = dict(module.nam_parameters())
    assert nam_parameters["parameter_a"].value == VAL_A
    assert nam_parameters["parameter_b"].value == VAL_B
    assert nam_parameters["extra_parameter_0"].value is None
...
def test_stacked_module(size_a, size_b, val):
    ...
    nam_parameters = dict(module.nam_parameters())
    assert nam_parameters["parameter_a"].value == val
    assert nam_parameters["module_a.parameter_a"].value == VAL_A
    assert nam_parameters["module_a.parameter_b"].value == VAL_B
    assert nam_parameters["module_b.parameter_a"].value == VAL_A
    assert nam_parameters["module_b.parameter_b"].value == VAL_B
